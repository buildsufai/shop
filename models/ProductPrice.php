 ...
 * @property integer $price_model_id
...
class ProductPrice extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('price_model_id, product_id, price, currency', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('price_model_id',$this->price_model_id);
